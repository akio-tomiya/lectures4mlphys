...
発表者: 佐野 崇 (東洋大)<br>
発表題目: 確率的グラフィカルモデルにおける変分近似法<br>
場所: 会議室のルビコン 601 [案内図](./ルビコン案内図.pdf)<br>
開催方法: 対面とオンラインのハイブリッド <br>
概要:
...
物理屋に分かりやすい言葉で説明していきたいと思います。
<br>
[参加登録フォーム](https://docs.google.com/forms/d/e/1FAIpQLSd8uYc2NMOuTs3jz9kkfUmy395w4mdwzxAvhHd6FAkDKJBAYw/viewform)
